...
import cl.ucn.disc.dsm.pjopia.model.newsapi.Article;
import cl.ucn.disc.dsm.pjopia.model.newsapi.NewsAPIResponse;
...
public class NewsAPIService implements Contracts {
    ...
    public List<News> retrieveNews(Integer size) {
        ...
        try {
            ...
            Response<NewsAPIResponse> theResponse = theCall.excecute();
